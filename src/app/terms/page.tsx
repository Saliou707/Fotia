...
// Date figée (constante) : évite un mismatch SSR/client et garde la page stable pour Google
const LAST_UPDATED = '1er janvier 2026'

export default function TermsOfUsePage() {
  return (
    <div className="terms-page" style={{ background: '#080808', color: '#F2EDE4', minHeight: '100vh', fontFamily: 'var(--font-inter, Inter, sans-serif)', padding: '60px 24px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <p style={{ color: '#A09890', fontSize: 16, marginBottom: 60 }}>Dernière mise à jour : {LAST_UPDATED}</p>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 40, lineHeight: 1.7, fontSize: 16, color: '#A09890' }}>
          
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>1. Objet</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>2. Utilisation du service et Compte Utilisateur</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>3. Forfaits et Paiements (Premium Pro)</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>4. Propriété intellectuelle et Contenus</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>5. Disponibilité et Hébergement</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>6. Limitation de responsabilité</h2>
            <p>
          ...
          <section style={{ padding: 24, background: '#111', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)' }}>
            <h2 style={{ fontSize: 20, fontWeight: 700, color: '#F2EDE4', marginBottom: 12 }}>7. Contact & Support</h2>
