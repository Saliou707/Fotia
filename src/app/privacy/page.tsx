...
export default function PrivacyPolicyPage() {
  return (
    <div className="privacy-page" style={{ background: '#080808', color: '#F2EDE4', minHeight: '100vh', fontFamily: 'var(--font-inter, Inter, sans-serif)', padding: '60px 24px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40, lineHeight: 1.7, fontSize: 16, color: '#A09890' }}>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>2. Données collectées</h2>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>3. Utilisation de vos données</h2>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>4. Sécurité et Hébergement</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>5. Partage d'informations avec des tiers</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: '#F2EDE4', marginBottom: 16 }}>6. Vos Droits</h2>
            <p>
